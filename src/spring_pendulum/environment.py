...
from .model import SpringCartPoleParams, default_params, downright_state
from .simulation import ControlLaw, SimulationResult, rollout_open_loop


@dataclass
class SpringPendulumEnv:
    params: SpringCartPoleParams = field(default_factory=default_params)
    dt: float = 0.02
    t_final: float = 10.0
