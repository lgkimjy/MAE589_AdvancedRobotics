...
from spring_pendulum.optimal_control import MPPIController
from spring_pendulum.visualization import AnimationOptions, animate_simulation


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="MPPI demo for the spring pendulum cart-pole.")
...
def main() -> None:
    ...
    if args.no_show and save_path is None:
        save_path = str(Path("outputs") / "spring_mppi_demo.mp4")
